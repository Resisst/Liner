from colorama import Fore;file_name = input(f"{Fore.GREEN}[{Fore.CYAN}>>>{Fore.GREEN}]{Fore.RESET} Enter the file name: ");file_name = "".join([file_name + ".py" if not file_name.endswith(".py") else file_name])
